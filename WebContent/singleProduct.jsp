        	...
        	<div class="row">
               ...
               <div class="col-xs-4 item-photo">
                ...
                <div class="col-xs-5" style="border:0px solid gray">
                    ...
                    <h3>${i.productName}</h3>    
                    <h5 style="color:#337ab7">Electronics | <a href="https://www.apple.com/">Reviews</a></h5>
        
                    <!-- Precios -->
                    <h6 class="title-price"><small>BLACK FRIDAY OFFER</small></h6>
                    <h3 style="margin-top:0px;">$ ${i.price}</h3>
